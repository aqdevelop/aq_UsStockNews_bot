...
#### 오후 10시 30분 (한국시간) - 이브닝브리프 🌙
- **한국**: 오후 10시 30분 (고정)
- **미국 동부**: 
  - 섬머타임(3-11월): 오전 9시 30분
  - 동절기(11-3월): 오전 8시 30분
- **내용**: 미국 장 시작 전후 주요 뉴스
...
#### 일요일 - 오전 7시 (한국시간) ☀️ + 🔥
- **오전 7시**: 주말 뉴스 요약
- **오전 7시 직후**: 🔥 **주간 핫 이슈 TOP 10** (GPT-4o)
  - 지난 7일간 뉴스 분석
  - Reddit WSB 화제 종목
  - Google Trends 검색량
  - GPT-4o 고품질 분석
...
#### 매월 1일 - 오전 7시 (한국시간) ☀️ + 🔥 + 📅
- **오전 7시**: 일반 뉴스 요약
- **오전 7시 직후**: 🔥 주간 핫 이슈 (일요일인 경우, GPT-4o)
- **오전 7시 직후**: 📅 **월간 핫 이슈 TOP 10** (GPT-4o)
  - 지난 30일간 뉴스 기록 심층 분석
  - 월간 시장 흐름 및 분위기
  - 섹터별 중요 이슈 정리
  - 다음 달 전망 포함
...
> 💡 **섬머타임 자동 처리**: Railway 서버가 자동으로 미국 섬머타임을 인식하므로, 한국시간은 연중 고정이며 미국시간만 자동 조정됩니다.
